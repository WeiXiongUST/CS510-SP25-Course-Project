...
class DPOTrainer(Trainer):
    ...
    def concatenated_forward(
        ...
        if self.aux_loss_enabled:
            return (chosen_logps, rejected_logps, chosen_logits, rejected_logits, nll_loss, outputs.aux_loss, torch.FloatTensor(batch['margin']))

        return (chosen_logps, rejected_logps, chosen_logits, rejected_logits, nll_loss, torch.FloatTensor(batch['margin']))
